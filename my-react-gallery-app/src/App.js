...
function GaleriaDeImagenes() {
  const [imagenes, setImagenes] = useState([
    { src: 'imgs/1.jpg', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
    { src: 'imgs/3.jpg', alt: 'Imagen 3', caption: 'Pie de foto Imagen 2' },
    { src: 'imgs/5.jpg', alt: 'Imagen 4', caption: 'Pie de foto Imagen 3' }
  ]);
